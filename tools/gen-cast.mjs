...
const mel = {
  // The actor NAME is the street handle — Foundry pushes it to tokens and chat,
  // and on the street he is just Mel. The government name goes in realName,
  // which is the field the sheet has for exactly this.
  _id: MEL_ID, name: "Mel", type: "character", img: IMG,
  system: {
    realName: "Melvin Offaleater",
    biography:
      ...
      + "<p>On the street he is <strong>Mel</strong>. On paper he is <strong>Melvin Offaleater</strong>, a name he cannot spell and has never once needed to.</p>"
